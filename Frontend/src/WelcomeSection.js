        ...
        <div class="rowW">
            <div class="col-6"> 
                  <div class="leftSide-col">
                    <h1 class="large">NOCTURNODE</h1>
                    <h1 class="large2">Nocturn is a team of accomplished validators with a strong focus on blockchain architecture. We deliver relayer services and contribute actively to the growth of various blockchain projects.</h1>
                    ...
                    <h1 class="large2">Founded in 2021, Nocturn had its fair share of funding challenges that initially slowed our development. Fast-forward to 2024, and we have fully assembled our team. Resembling nocturnal bats on the hunt, we are prepared to excel in the blockchain ecosystem.</h1>

                  </div>
            </div>
            <div class="col-6">
                <div class="rightSide-col">
                <img src={logoUrl} alt="NocturNode Logo" class="logo" />
                </div>
            </div>
        </div>
    </div>
