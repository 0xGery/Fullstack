...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy">
      ...
      <h2>Welcome to Nocturnode.tech</h2>
...
<p>This Privacy Policy is a testament to Nocturnode's unwavering dedication to privacy, our commitment as a DAO to open-source values, and our resolve to ensure our users' data security and privacy. We acknowledge that privacy laws and regulations vary by country, and we are committed to compliance with all applicable laws and standards.
</p>

<p className='aha'><i>Nocturnode.tech - Privacy, Transparency, and Community at the Forefront.</i></p>
    </div>
  );
};
